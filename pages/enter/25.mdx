...
This is what the planet information pane looks like. It contains a *lot* of information. If you want to learn about the individual stats, please check out the "guide written by DFDAO".
...
Wow. Looks like a lot of stuff out there! The dotted rings indicate how far my planet ‘Flaky Dry’ can reach with its range stat. To reach that big planet in the top left, I will need to first capture some larger, or closer (or preferably, *both* larger and closer) planets.
